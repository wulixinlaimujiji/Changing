...
public:
		...
		: Layer("Example"), m_Camera(-1.6f, 1.6f, -0.9f, 0.9f), m_CameraPosition(0.0f)
	{
		...
		std::shared_ptr<Changing::VertexBuffer> vertexBuffer;
		...
		std::shared_ptr<Changing::IndexBuffer> indexBuffer;
		...
		std::shared_ptr<Changing::VertexBuffer> squareVB;
		...
		std::shared_ptr<Changing::IndexBuffer> squareIB;
