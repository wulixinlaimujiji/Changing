...
IncludeDir["yaml_cpp"] = "%{wks.location}/Changing/vendor/yaml-cpp/include"
IncludeDir["ImGuizmo"] = "%{wks.location}/Changing/vendor/ImGuizmo"
...
group "Dependencies"
	...
	include "Changing/vendor/yaml-cpp"
group ""
