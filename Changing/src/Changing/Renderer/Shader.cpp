...
namespace Changing {
	...
	Changing::Ref<Changing::Shader> ShaderLibrary::Load(const std::string& filepath)
	{
	...
	Changing::Ref<Changing::Shader> ShaderLibrary::Get(const std::string& name)
	{
		CHNG_CORE_ASSERT(Exists(name), "Shader not found!");
